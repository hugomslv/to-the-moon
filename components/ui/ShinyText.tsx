...
// ReactBits – ShinyText : effet de brillance animée sur le texte
  ...
  useAnimationFrame(time => {
    ...
    if (yoyo) {
      ...
      if (cycleTime < animationDuration) {
        ...
        progress.set(directionRef.current === 1 ? 100 - (reverseTime / animationDuration) * 100 : (reverseTime / animationDuration) * 100);
      } else {
